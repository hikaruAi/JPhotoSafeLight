...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.useNumpy = QtWidgets.QCheckBox(self.centralwidget)
        self.useNumpy.setGeometry(QtCore.QRect(310, 300, 121, 17))
        self.useNumpy.setChecked(False)
        self.useNumpy.setObjectName("useNumpy")
        ...
        self.useNumpy.setText(_translate("MainWindow", "Use Numpy(slow)"))
